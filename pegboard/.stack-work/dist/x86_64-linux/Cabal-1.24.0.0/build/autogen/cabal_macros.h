...
/* package pegboard-0.1.0.0 */
#define VERSION_pegboard "0.1.0.0"
#define MIN_VERSION_pegboard(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "pegboard-0.1.0.0-FjeDzkb0etYsOVuQKSaT2"

#define CURRENT_PACKAGE_KEY "pegboard-0.1.0.0-FjeDzkb0etYsOVuQKSaT2"
